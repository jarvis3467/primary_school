...
<form method="post" action="delete_parent.php">
...
if (isset($_POST['submit'])) {
    ...
    $sql = "DELETE FROM parent WHERE Parent_ID=$Pid";

    if($connection->query($sql) === TRUE) {
        echo "parents record delete successful<br>";
    }else{
        echo "Errors on delete parents record: " . $connection->error;
    }
    $connection->close();
