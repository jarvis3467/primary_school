...
<head>
    ...
    <title>Delete_Attendance record</title>
</head>
<body>
...
if(isset($_POST['submit'])) {
    ...
    $sql = "DELETE FROM attendance WHERE Attendance_ID=$PId";

    if($connection->query($sql) === TRUE) {
        echo "Attendance record delete successful<br>";
    }else{
        echo "Errors on delete attendance record: " . $connection->error;
    }
    $connection->close();
