...
<br>
<div class="container">
    <a class="btn btn-primary" href="add_attendance.php" role="button">Add Attendance record</a>
    <br>
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            while($row= $result->fetch_assoc()) {
              ...
              <td>$row[Class_ID]</td>
              <td>
              <a class= 'btn btn-primary btn-sm' href = 'update_attendance.php?id=$row[Attendance_ID]'>Update</a>
              <a class= 'btn btn-warning btn-sm' href = 'delete_attendance.php?id=$row[Attendance_ID]'>Delete</a>
              </td>
              ";
            }
            ?>
