...
<br>
<div class="container">
    <a class="btn btn-primary" href="add_subject.php" role="button">Add subjects</a>
    <br>
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            while($row =$result->fetch_assoc()) {
                ...
                <td>$row[Class_ID]</td>
                <td>
                <a class= 'btn btn-primary btn-sm' href = 'update_subject.php?id=$row[Subject_ID]'>Update</a>
                <a class= 'btn btn-warning btn-sm' href = 'delete_subject.php?id=$row[Subject_ID]'>Delete</a>
                </td>
                ";
            }
            ?>
